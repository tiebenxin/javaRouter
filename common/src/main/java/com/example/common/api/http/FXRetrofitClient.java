...
import com.example.common.api.JHttpLoggingInterceptor;
import com.example.common.api.RetrofitClient;
import com.example.common.api.SSL;
import com.example.common.api.SystemUtil;
import com.example.common.api.http.interceptor.CommonInterceptor;
...
//         * 本地缓存
//         */
//        File cacheFile = new File(ContextHelper.getContext().getCacheDir(), "cache");
